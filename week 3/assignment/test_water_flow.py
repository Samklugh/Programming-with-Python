...
def test_water_column_height():
    ...
    assert water_column_height(0.0, 0.0) == approx(0.0, 0.01)
    assert water_column_height(0.0, 10.0) == approx(7.5, 0.01)
    assert water_column_height(25.0, 0.0) == approx(25.0, 0.01)
...
def test_pressure_loss_from_pipe_reduction():
    ...
    assert pressure_loss_from_pipe_reduction(0.28687, 0.00, 1, 0.048692) == approx(0.00, 0.001)
